...
class WebmasterBank extends Model
{
    protected $table = 'webmaster_bank';

    //获取列表
    public static function getBanks($where=[], $order=[], $offset=0, $limit='')
    {
    ...
    //获取单个
    public static function getBank($where=[], $order=[])
    {
    ...
    //修改
    public static function putBank($where, $data)
    {
    ...
    //删除
    public static function delBank($where)
    {
        if(empty($where))
            return false;
