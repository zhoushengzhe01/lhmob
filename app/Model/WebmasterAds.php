...
class WebmasterAds extends Model
{
    protected $table = 'webmaster_ads';

    //获取列表
    public static function getAds($where=[], $order=[], $offset=0, $limit='')
    {
    ...
    //获取单个
    public static function getAd($where=[], $order=[])
    {
    ...
    //添加
    public static function postAd($data)
    {
    ...
    //修改
    public static function putAd($where, $data)
    {
    ...
    //删除
    public static function delAd($where)
    {
        if(empty($where))
            return false;
