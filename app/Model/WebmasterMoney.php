...
class WebmasterMoney extends Model
{
    protected $table = 'webmaster_money';

    //获取列表
    public static function getWebmasters($where=[], $order=[], $offset=0, $limit='')
    {
    ...
    //获取单个
    public static function getWebmaster($where=[], $order=[])
    {
    ...
    //添加
    public static function postWebmaster($data)
    {
    ...
    //修改
    public static function putWebmaster($where, $data)
    {
    ...
    //删除
    public static function delWebmaster($where)
    {
        if(empty($where))
            return false;
