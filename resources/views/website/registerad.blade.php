...
<div class="register">
	<div class="box">
		<div class="main">
			<a href="{{$group->url}}/register/web" class="weblogin">网站主注册</a>
			<a href="javascript:void(0)" class="advertlogin action">广告主注册</a>
		</div>
		<div class="content">
			<div class="register_form action">
				...
				<div class="group">
					<label>公司名称</label>
					<input name="company" class="input" type="text" placeholder="输入公司名称"/> <span class="tishi"><b>*</b></span>
				</div>
				<div class="group">
					<label>联&nbsp; 系 人</label>
				...
				<div class="group">
					...
					<option value="{{$val['id']}}" @if($val['id']==$user_id) selected @endif>领航商务--{{$val['stagename']}}</option>
					@endforeach
				...
				<div class="group">
					{!! csrf_field() !!}
					<button class="submit" onclick="submit()">注册广告主</button>
					<div class="login1">已有账号，<a href="{{$group->url}}/login/ad"><b>点击登录</b></a></div>
				</div>
