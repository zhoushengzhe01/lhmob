...
<div class="tool o_h">
    <form method="get" action="">
        ...
        <input class="text" type="text" name="webmaster_id" size="12" value="{{$paramet['webmaster_id']}}" placeholder="站长ID">
        <input class="text" type="text" name="myads_id" size="12" value="{{$paramet['myads_id']}}" placeholder="广告ID">
...
{!! $browsers->appends($paramet)->links() !!}
